...
def add_ateacher_config(cfg):
    ...
    _C.SEMISUPNET.ALIGN_NORMED = True
    _C.SEMISUPNET.ALIGN_SUBSAMPLING =  "random"
    _C.SEMISUPNET.ALIGN_USE_BG = False
    _C.SEMISUPNET.ALIGN_POINTS_PER_PROPOSALS = 10
    _C.SEMISUPNET.ALIGN_QUEUE_LENGHT = 200
    _C.SEMISUPNET.ALIGN_MAX_BATCH = 200
    _C.SEMISUPNET.ALIGN_SCALE_COUNT = False
    _C.SEMISUPNET.ALIGN_BASE_COUNT = 500
    _C.SEMISUPNET.USE_GT_PROPOSALS = False
    _C.SEMISUPNET.USE_GT_PROPOSALS_ONLY = False
    _C.SEMISUPNET.ALIGN_USE_NEGATIVES = False
    _C.SEMISUPNET.ALIGN_GT_PROPOSALS = False
