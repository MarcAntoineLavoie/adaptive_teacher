...
class DetectionCheckpointerEVA(DetectionCheckpointer):
    ...
    def load2(self, path, checkpointables):
        """
...
def do_train(args, cfg, cfg_base):
    """
    Args:
    ...
    # checkpointer = DetectionCheckpointerEVA(
    #     model,
